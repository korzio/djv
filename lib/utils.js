...
var fieldValidate = {
    ...
    */
    'minLength': 'typeof $1 === "string" && function ucs2decodeLength(d){for(var c=[],b=0,f=d.length,a,e;b<f;)a=d.charCodeAt(b++),55296<=a&&56319>=a&&b<f?(e=d.charCodeAt(b++),56320==(e&64512)?c.push(((a&1023)<<10)+(e&1023)+65536):(c.push(a),b--)):c.push(a);return c.length}($1) < $2',
    'maxLength': 'typeof $1 === "string" && function ucs2decodeLength(d){for(var c=[],b=0,f=d.length,a,e;b<f;)a=d.charCodeAt(b++),55296<=a&&56319>=a&&b<f?(e=d.charCodeAt(b++),56320==(e&64512)?c.push(((a&1023)<<10)+(e&1023)+65536):(c.push(a),b--)):c.push(a);return c.length}($1) > $2',
