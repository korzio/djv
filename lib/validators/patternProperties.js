module.exports = function patternProperties(schema, fn) {
  const hasAdditionalProperties = schema.hasOwnProperty('additionalProperties') && schema.additionalProperties !== true;
  ...
  if (hasPatternProperties) {
    for (const propertyKey in schema.patternProperties) {
